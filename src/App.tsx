...
import TailwindTest from "./ComponentLibraryTests/Tailwind";
...
function getIcon(lib: ComponentLibrarys): string {
    switch (lib) {
        ...
        case ComponentLibrarys.TAILWIND:
            return 'https://tailwindcss.com/_next/static/media/tailwindcss-mark.79614a5f61617ba49a0891494521226b.svg';
...
function App() {
    ...
    return (<div>
            ...
            {lib === ComponentLibrarys.TAILWIND && <TailwindTest/>}
            {lib === ComponentLibrarys.COMPARISON && <div className="flex flex-row"><AntDesignTest themeColor={themeColor}/> <TailwindTest/></div>}
        </div>
    );
}
